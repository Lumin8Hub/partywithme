...
export const parties: Party[] = [
  ...
  },
  {
    slug: "mug-painting",
    name: "Mug Painting",
    hook: "Paint a keepsake mug that's truly one of a kind — and totally theirs.",
    about: [
      "Kids design and paint their own ceramic-style mug with bright, kid-safe paints, creating a keepsake they'll actually use.",
      "A relaxed, creative party with a take-home everyone loves.",
    ],
    price: 320,
    perChild: 25,
    accent: "blue",
    icon: "Coffee",
    image: asset("/images/craft-markers.jpg"),
    categories: ["Crafty"],
    included: [
      "A mug and full paint kit per kid",
      "Guided design ideas",
      "Aprons and table protection",
      "A finished mug to take home",
      "Set-up and clean-up handled by us",
    ],
    addons: ["Larger mug", "Matching set", "Custom stencils"],
    gallery: [asset("/images/craft-markers.jpg"), asset("/images/paint-watercolor.jpg"), asset("/images/paint-body.jpg")],
  },
  {
    slug: "bedazzling",
    name: "Bedazzling",
    hook: "Bling out tees, totes and accessories with gems and sparkle.",
    about: [
      "A sparkly, customise-everything party where kids bedazzle tees, totes and accessories with gems, studs and shine.",
      "We're putting the finishing touches on this one — coming soon!",
    ],
    price: null,
    perChild: null,
    accent: "pink",
  ...
  {
    slug: "stuffed-animal-making",
    name: "Stuffed-Animal Making",
    hook: "Stuff, dress and name a cuddly new best friend to take home.",
    about: [
...
export const partyCategories: PartyCategory[] = ["Crafty", "Active", "Magical", "Science-y"];
